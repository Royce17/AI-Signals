...
Awesome-AI-Signals — CLI tool that fetches curated AI blogs/podcasts from Substack, RSS, and Xiaoyuzhou FM into local Markdown files. Node.js 22+ / Bun, ESM, minimal dependencies (only `js-yaml`).
...
| `.awesome-ai-signals-state.json` | Incremental fetch state (gitignored) |

## Conventions

### Naming

- **Project name**: `Awesome AI Signals` — display name in prose and docs.
- **npm package / CLI command / state file / config dir**: `awesome-ai-signals` — lowercase kebab-case for all technical identifiers.
- **GitHub repo**: `royce17/awesome-ai-signals` — matches the npm package name.
